...
export default async function CsvLeadsPage() {
  ...
  const [importedLeads, emailBodyTemplate] = await Promise.all([
  ...
  return <section className="stack leads-page"><div className="page-title"><h1>CSV Leads</h1><p>Import and contact external lead lists without mixing them into app-generated leads.</p></div><CsvLeadWorkspace leads={leads} emailBodyTemplate={emailBodyTemplate} /></section>;
}
